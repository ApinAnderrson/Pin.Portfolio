          ...
          <div className="max-w-screen-2xl w-full h-full bg-white flex flex-col">
            <div className="relative w-full h-full flex flex-col justify-center items-center">
              ...
              <div className="absolute cards  gap-5 w-full z-999 p-14 items-center grid grid-cols-12 ">
                <div className="col-span-6 bg-[url(./img/companyProfile/cover.png)] bg-cover bg-center rounded-xl aspect-[4/3]"
                style={{
              ...
              <div className="absolute cards  gap-5 w-full z-999 p-14 items-center grid grid-cols-12 ">
                <div className="col-span-6 bg-[url(./img/companyProfile/capyschool.png)] bg-cover bg-center rounded-xl aspect-[4/3]"
                style={{
                  backgroundImage: `url("${import.meta.env.BASE_URL}img/companyProfile/capyschool.png")`,
                }}></div>
                <div className="col-span-6 flex flex-col gap-4">
                  <div className="w-full ">
                    <div className="flex flex-col justify-center gap-4">
              ...
              <div className="absolute cards  gap-5 w-full z-999 p-14 items-center grid grid-cols-12 ">
                <div className="col-span-6 bg-[url(./img/companyProfile/GTATravels.png)] bg-cover bg-center rounded-xl aspect-[4/3]"
                style={{
                  backgroundImage: `url("${import.meta.env.BASE_URL}img/companyProfile/GTATravels.png")`,
                }}></div>
                <div className="col-span-6 flex flex-col gap-4">
                  <div className="w-full ">
                    <div className="flex flex-col justify-center gap-4">
